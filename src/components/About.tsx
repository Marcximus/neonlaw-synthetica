    ...
    <section className="py-16 sm:py-32 relative overflow-hidden bg-gradient-to-b from-black via-black/95 to-black">
      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <motion.div 
            className="mb-12 glass p-2 rounded-full max-w-[240px] mx-auto neon-border-wrapper"
          ...
          <div className="glass p-6 sm:p-8 rounded-xl mb-8 neon-border-wrapper">
          ...
          <div className="grid grid-cols-2 gap-4 sm:gap-6 w-full">
            <div className="glass p-6 rounded-lg neon-border-wrapper">
